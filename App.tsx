      ...
      {showHelp && (
        <div className="modalOverlay" onClick={() => setShowHelp(false)}>
          <div className="modalContent" onClick={(e) => e.stopPropagation()}>
            <button className="closeButton" onClick={() => setShowHelp(false)}>
              <span className="icon">close</span>
            </button>
            <h2>How to Use Robo AI - Video Analyzer</h2>
            <ol>
              <li>
                <strong>Upload a Video:</strong> Drag and drop a video file
                anywhere onto the page to begin. The app will process it for
                analysis.
              </li>
              <li>
                <strong>Choose an Analysis Mode:</strong> Use the sidebar on the
                left to select how you want to analyze your video. You can
                generate:
                <ul>
                  <li>
                    <strong>A/V Captions:</strong> Get a scene-by-scene
                    description with spoken text.
                  </li>
                  <li>
                    <strong>Paragraph:</strong> A concise summary of the video.
                  </li>
                  <li>
                    <strong>Key Moments:</strong> A bulleted list of important
                    events.
                  </li>
                  <li>
                    <strong>Table:</strong> A structured view of key shots with
                    objects identified.
                  </li>
                  <li>
                    <strong>Haiku:</strong> A poetic 5-7-5 summary.
                  </li>
                  <li>
                    <strong>Chart:</strong> Visualize data like excitement
                    levels or number of people over time.
                  </li>
                  <li>
                    <strong>Custom:</strong> Write your own prompt for a
                    tailored analysis.
                  </li>
                </ul>
              </li>
              <li>
                <strong>Generate & Interact:</strong> Click the "Generate"
                button. Once the results appear, you can click on any timestamp
                (e.g., <time>0:15</time>) to jump directly to that point in the
                video.
              </li>
            </ol>
          </div>
